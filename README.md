...
Ao todo foram selecionados para a simulação cinco níveis de temperatura de injeção (280,255,230,205 e 180°C), três níveis da pressão de injeção (90,75 e 60% da pressão máxima de injeção)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMzQwMTg3NDhdfQ==
-->